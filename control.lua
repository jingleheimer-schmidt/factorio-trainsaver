...
local function add_commands()
    ...
    commands.add_command("ts-reset_history", { "ts-command-help.ts-reset-history" }, reset_history)
    ...
    commands.add_command("ts-next_target", { "ts-command-help.ts-next-target" }, focus_next_target)
    commands.add_command("ts-previous_target", { "ts-command-help.ts-previous-target" }, focus_previous_target)
end
