...
local function add_commands()
    commands.add_command("trainsaver", { "ts-command-help.trainsaver" }, start_or_end_trainsaver)
    commands.add_command("ts-start", { "ts-command-help.ts-start" }, start_trainsaver)
    commands.add_command("ts-end", { "ts-command-help.ts-end" }, end_trainsaver)
    commands.add_command("ts-verbose", { "ts-command-help.ts-verbose" }, toggle_chatty)
    commands.add_command("ts-reset_history", { "ts-command-help.ts-reset_history" }, reset_history)
    commands.add_command("ts-ignore_stations", { "ts-command-help.ts-ignore_stations" }, ignore_stations)
    commands.add_command("ts-unignore_stations", { "ts-command-help.ts-unignore_stations" }, unignore_stations)
    commands.add_command("ts-list_ignored_stations", { "ts-command-help.ts-list_ignored_stations" }, list_ignored_stations)
    commands.add_command("ts-next_target", { "ts-command-help.ts-next_target" }, focus_next_target)
    commands.add_command("ts-previous_target", { "ts-command-help.ts-previous_target" }, focus_previous_target)
end
