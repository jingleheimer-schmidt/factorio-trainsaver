...
local function create_waypoint(waypoint_target, player_index)
    ...
    local created_waypoints = {
        {
            ...
            zoom = zoom,
            surface = waypoint_target.surface.name,
        },
    }
    ...
    if waypoint_2_end_entity.valid and (waypoint_2_end_entity.surface_index == waypoint_target.surface_index) then
        local waypoint_2 = {
            target = waypoint_2_end_entity,
            transition_time = transition_time_2,
            time_to_wait = 60,
            zoom = zoom,
            surface = waypoint_2_end_entity.surface.name,
        }
